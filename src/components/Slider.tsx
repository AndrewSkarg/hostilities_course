...
const Slider: React.FC<SliderProps> = ({ posts }) => {
    ...
    return (
        <div className=" w-full md:flex">
            <Swiper ref={swiper} navigation={true} modules={[Navigation, Autoplay, Controller]} className="mySwiper text-black" autoplay={swiperAutoplay} onSwiper={(swiper) => {
            }} onSlideChange={(swiper) => {
                setActiveIndex(swiper.activeIndex);
            }} >
                {slides}
            </Swiper>
            <div className="text-sm md:w-[60%] md:text-base text-black">
