...
import { getStatistics } from '../features/warStatistic/statisticSlice';
import WarStatistic from '../components/WarStatistic';
...
const News = () => {
    ...
    const warStatistics = useSelector((state: any) => state.statistic.statistics);
    // console.log(warStatistics)
    ...
    // let totalPage = Math.ceil(filteredPosts.length / limit);
        ...
        await axios.get(externalSiteURL)
            .then(response => {
                ...
                for (const element of elementsWithDataUrl) {
                    const articleTextElement = element.querySelector('.article-text');
                    if (articleTextElement) {
                        setArticleText(articleTextElement.textContent as string);
                        break;
                    }
                }
            })
    ...
    return (
        <div className="w-full">
            ...
            <section className="flex flex-col flex-wrap md:flex-row    w-full mt-40  text-center md:text-left text-black ">

                {/* <h2 className="w-[100%] mb-12 text-3xl font-bold" ref={news}>Всі новини</h2> */}

                <div className='flex flex-col flex-wrap w-[100%] md:w-[60%] '>
                    <LineHead text='Всі новини' color="0000" />

                    <div className="mb-6  w-full grid grid-cols-1  md:grid-cols-2 ">
                ...
                <div className='flex flex-col flex-wrap w-[100%] md:w-[30%] md:ml-[10%] '>
                    <LineHead text='Втрати окупанта' color='00FF00' />
                    <WarStatistic data={warStatistics} />
                    <LineHead text='Галерея зображень' color='00FF00' />
                    <MiniGallery />
                </div>
            ...
            <Pagination />
            <LineHead text='Відеоматеріали' color='f00' />
